  ...
  <div class="relative" ref="dropdownRef">
    ...
    >
      <div>
        ...
        <span class="mt-0.5 block text-theme-xs text-gray-500 uppercase dark:text-gray-400">
...
const router = useRouter() // 3. Inisialisasi Router untuk memindah halaman
...
// 4. Logika Sign Out yang sesungguhnya
const signOut = () => {
  authStore.logout() // Panggil fungsi hapus token dari Pinia
  closeDropdown() // Tutup menu dropdown
  router.push({ name: 'Signin' }) // Arahkan pengguna kembali ke halaman Login
}
